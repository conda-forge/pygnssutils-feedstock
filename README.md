...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pygnssutils-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pygnssutils-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pygnssutils
# for installing globally
pixi global install pygnssutils
```
...
It is possible to list all of the versions of `pygnssutils` available on your platform:
...
```
pixi search pygnssutils --channel conda-forge
```
